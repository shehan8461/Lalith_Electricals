  ...
  <div className="d-flex flex-column min-vh-100 animated-bg" style={{paddingTop: '16rem'}}>
      ...
      `}</style>
        ...
        {showModal && selectedOrder && (
          <div className="modal fade show d-flex align-items-center justify-content-center" style={{position:'fixed', top:245, left:0, right:0, width:'100%', height:'calc(100vh - 200px)', display:'flex', background:'rgba(0,0,0,0.5)', zIndex:1050, overflowY:'auto', alignItems:'flex-start'}} tabIndex="-1" role="dialog" onClick={()=>setShowModal(false)}>
